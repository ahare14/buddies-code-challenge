...
class BeersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create beer" do
    assert_difference('Beer.count') do
      post beers_url, params: { beer: { abv: @beer.abv, description: @beer.description, food: @beer.food, image: @beer.image, name: @beer.name } }, as: :json
    end
  ...
  test "should update beer" do
    patch beer_url(@beer), params: { beer: { abv: @beer.abv, description: @beer.description, food: @beer.food, image: @beer.image, name: @beer.name } }, as: :json
    assert_response 200
  end
